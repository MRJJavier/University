...
alicePriv=cargar_RSAKey_Privada(path+"alicepriv.txt","alicepriv")
bobPub=cargar_RSAKey_Publica(path+"bobpub.txt")
texto="Hola amigos de la seguridad"
cifrado=cifrarRSA_OAEP(texto,bobPub)
firma=firmarRSA_PSS(texto,alicePriv)
guardar_En_Fichero(path+"alicecif.txt",cifrado)
guardar_En_Fichero(path+"alicefir.txt",firma)
