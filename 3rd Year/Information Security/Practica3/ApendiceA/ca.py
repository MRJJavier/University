...
print("Claves Alice")
aliceKey=crear_RSAKey()
guardar_RSAKey_Privada(path+"alicepriv.txt",aliceKey,"alicepriv")
guardar_RSAKey_Publica(path+"alicepub.txt",aliceKey.publickey())
print("Claves Bob")
bobKey=crear_RSAKey()
guardar_RSAKey_Privada(path+"bobpriv.txt",bobKey,"bobpriv")
guardar_RSAKey_Publica(path+"bobpub.txt",bobKey.publickey())
