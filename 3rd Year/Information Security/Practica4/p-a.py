...
cifrado, cifrado_mac, cifrado_nonce = cifraPaso1("A", "T", KAT, "Alice", t_n)
...
t_KA, t_KB, t_ne = descifraPasos1y3("A", KAT, cifrado, cifrado_mac, cifrado_nonce)
...
socket.enviar(cifraCTR(t_KA,t_KB,"Nombre"))
