...
def cifraPaso1(emisor, receptor, KET, K1, K2, t_ne):
...
cifrado, cifrado_mac, cifrado_nonce = cifraPaso1("T","B",KBT,K1,K2,t_nb)
...
cifrado, cifrado_mac, cifrado_nonce = cifraPaso1("T","A",KAT,K1,K2,t_na)
