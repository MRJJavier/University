...
ALTER TABLE beneficiario ADD CONSTRAINT beneficiario_pk PRIMARY KEY ( código );
...
CREATE TABLE centro (
    ...
    código_tipo_centro           NUMBER NOT NULL
);

CREATE UNIQUE INDEX centro__idx ON
    centro (
...
ALTER TABLE tipo_centro ADD CONSTRAINT tipo_centro_un UNIQUE ( tipo );

ALTER TABLE centro
    ADD CONSTRAINT centro_tipo_centro_fk FOREIGN KEY ( código_tipo_centro )
...
ALTER TABLE contabilidad
    ADD CONSTRAINT contabilidad_centro_fk FOREIGN KEY ( centro_código )
...
ALTER TABLE beneficiario
    ADD CONSTRAINT beneficiario_centro_fk FOREIGN KEY ( centro_código )
        REFERENCES centro ( código );

ALTER TABLE personal_asociación
    ADD CONSTRAINT per_as_centro_fk FOREIGN KEY ( centro_código )
        REFERENCES centro ( código );

ALTER TABLE proyecto
    ADD CONSTRAINT proyecto_centro_fk FOREIGN KEY ( centro_código )
        REFERENCES centro ( código );

ALTER TABLE centro
    ADD CONSTRAINT centro_per_as_fk FOREIGN KEY ( personal_asociación_código )
