#!/bin/bash
for i in *
# Para cada entrada "i" del directorio donde se ejecuta el script
do
if [ -d "$i" ]
# Chequea si dicha entrada "$i" es un directorio
then
# En caso de serlo
...
echo "$i: $FILES2"
# Muestra el nombre del directorio y el número de
